...
namespace cx.Application.Web
{
    ...
    public class HandlerErrorAttribute : HandleErrorAttribute
    {
        ...
        public override void OnException(ExceptionContext context)
        {
            ...
            string msg = "辰星科技提醒您：" + context.Exception.Message;
            if (msg == "辰星科技提醒您：所需的防伪表单字段“__RequestVerificationToken”不存在。")
            {
                msg = "系统貌似出问题了，可联系辰星科技售后人员。";
            }
        ...
        private void SendMail(string body)
        {
            ...
            if (ErrorToMail == true)
            {
                ...
                MailHelper.Send("receivebug@cx.cn", SystemName + " - 发生异常", body.Replace("-", ""));
            }
        }
    }
}