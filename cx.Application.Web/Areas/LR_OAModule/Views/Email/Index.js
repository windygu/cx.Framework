    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_getemail').on('click', function () {
                cx.loading(true);
                cx.httpAsyncGet(top.$.rootUrl + '/LR_OAModule/Email/GetMail', function (res) {
                    console.log(res);
                    cx.loading(false);
                    page.search();
                });
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (cx.checkrow(keyValue)) {
                    cx.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            cx.deleteForm(top.$.rootUrl + '/LR_OAModule/Email/DeleteForm', { keyValue: keyValue, type: currentPage }, function () {
                                refreshGirdData();
                            });
                        }
                    });
