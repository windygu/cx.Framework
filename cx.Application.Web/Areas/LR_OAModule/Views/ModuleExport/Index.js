    ...
    var page = {
        ...
        bind:function(){
            ...
            $("#btn_export_Excel").on('click', function () {
                cx.download({ url: top.$.rootUrl + '/LR_OAModule/ModuleExport/ExportExcel', param: { keyValue: "3587a099-980d-4342-864f-a9f48e90e03b", __RequestVerificationToken: $.lrToken }, method: 'POST' });
            });
            //导出Word
            $("#btn_export_Word").on('click', function () {
                cx.download({ url: top.$.rootUrl + '/LR_OAModule/ModuleExport/ExportWord', param: { keyValue: "3587a099-980d-4342-864f-a9f48e90e03b", __RequestVerificationToken: $.lrToken }, method: 'POST' });
            });
            //导出PDF
            $("#btn_export_PDF").on('click', function () {
                cx.download({ url: top.$.rootUrl + '/LR_OAModule/ModuleExport/ExportPDF', param: { __RequestVerificationToken: $.lrToken }, method: 'POST' });
            });
        }
    };
    page.init();
