...
var bootstrap = function ($, cx) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            cx.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/DatabaseTable/GetFieldList', { databaseLinkId: dbId, tableName: tableName }, function (data) {
    ...
    acceptClick = function (callBack) {
        ...
        var resdata = {};
        resdata.id = keyValue || cx.newGuid();
