                ...
                nodeClick: function (item) {
                    switch (item.value)
                    {
                        case 'cxtree':
                            ...
                            $('#cx_tree_area').parent().find('.showarea-list-item.active').removeClass('active');
                            $('#cx_tree_area').addClass('active');
                            pluginlist.treeinit();
                            break;
                        case 'cxselect':
                            $('#title_info').text(item.text);
                            $('#cx_select_area').parent().find('.showarea-list-item.active').removeClass('active');
                            $('#cx_select_area').addClass('active');
                            pluginlist.selectinit();
                            break;
                        case 'cxuserselect':
                            $('#title_info').text(item.text);
                            $('#cx_selectuser_area').parent().find('.showarea-list-item.active').removeClass('active');
                            $('#cx_selectuser_area').addClass('active');
