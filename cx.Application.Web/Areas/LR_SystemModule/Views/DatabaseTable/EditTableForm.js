        ...
        bind: function () {
                ...
                cx.layerForm({
                    ...
                    callBack: function (id) {
                        return top[id].acceptClick(function (data) {
                            ...
                            cx.httpAsyncGet(top.$.rootUrl + '/LR_SystemModule/DatabaseTable/GetFieldList?databaseLinkId=' + data.databaseLinkId + '&tableName=' + data.tableName, function (res) {
            ...
            $('#lr_copyrow').on('click', function () {
                ...
                if (selectedRow.length > 0) {
                    ...
                    top.cx.alert.warning('请选择需要复制的行!');
                }
            });
        ...
        checkGrid: function (data) {
            ...
            $.each(data, function (_index, _item) {
                ...
                if (_item.f_column === undefined || _item.f_column === '') {
                    cx.alert.error('【第' + _index + '列】列名为空');
                    flag = false;
                    return false;
                }
                    ...
                    cx.alert.error('【第' + _index + '列】数据类型为空');
                    flag = false;
                    return false;
                }
                else if (_item.f_datatype == 'varchar' && (_item.f_length == 0 || _item.f_length == undefined)) {
                    cx.alert.error('【第' + _index + '列】字串长度设置错误');
                    flag = false;
                    return false;
                }
                else if (map[_item.f_column] != undefined ){
                    cx.alert.error('【第' + _index + '列与第' + map[_item.f_column] + '列】列名重复');
                    flag = false;
                    return false;
                }
