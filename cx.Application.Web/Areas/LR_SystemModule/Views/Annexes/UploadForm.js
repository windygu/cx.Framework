...
var bootstrap = function ($, cx) {
    ...
    $.lrSetForm(top.$.rootUrl + '/LR_SystemModule/Annexes/GetAnnexesFileList?folderId=' + keyVaule, function (data) {
        for (var i = 0, l = data.length; i < l; i++) {
            ...
            $item.append('<span class="lr-file-name">' + item.F_FileName + '(' + cx.countFileSize(item.F_FileSize) + ')</span>');
    ...
    var DeleteFile = function (fileId) {
        ...
        cx.httpAsyncPost(top.$.rootUrl + "/LR_SystemModule/Annexes/DeleteAnnexesFile", param, function (res) {});
    ...
    var DownFile = function (fileId) {
        cx.download({ url: top.$.rootUrl + '/LR_SystemModule/Annexes/DownAnnexesFile', param: { fileId: fileId, __RequestVerificationToken: $.lrToken }, method: 'POST' });
    }
