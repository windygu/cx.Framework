/*
 * 版 本 cx-ADMS V7.0.0 力软 敏捷开发框架(http://www.cx.cn)
...
(function ($, cx) {
    ...
    $.extend(cx, {
        ...
        getDate: function (format, strInterval, Number) {
            ...
            var res = cx.formatDate(myDate, format);
            return res;
        },
        // 月
        getMonth:function(){
            ...
            var currentDate = cx.parseDate(cx.formatDate(new Date(), "yyyy-MM-01"));
            var endDate = currentDate.DateAdd('m', 1).DateAdd('d', -1);

            res.begin = cx.formatDate(currentDate, 'yyyy-MM-dd 00:00:00');
            res.end = cx.formatDate(endDate, 'yyyy-MM-dd 23:59:59');
        ...
        getPreMonth: function () {
            ...
            res.begin = cx.formatDate(preMonth, 'yyyy-MM-01 00:00:00');
            res.end = cx.formatDate(preMonth, 'yyyy-MM-dd 23:59:59');
        ...
        getCurrentQuarter: function () {
            ...
            return cx.getQuarter(currentDate.getFullYear(), currentDate.getMonth());
        },
