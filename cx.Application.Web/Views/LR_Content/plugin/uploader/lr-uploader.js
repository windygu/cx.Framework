/*
 * 版 本 cx-ADMS V7.0.0 力软敏捷开 发 框架(http://www.cx.cn)
        ...
        openUploadForm: function () {
            ...
            cx.layerForm({
                ...
                btn: null,
                    ...
                    cx.httpAsyncGet(top.$.rootUrl + '/LR_SystemModule/Annexes/GetFileNames?folderId=' + dfop.value, function (res) {
