    ...
    $.lrdate = {
        init: function ($self) {
            ...
            $datepickerBtn.find('a').on('click', function () {
                ...
                var $text = $self.find('#lr_search_date_' + dfop.id);
                $container.hide();
                var label = cx.formatDate(dfop._begindate, 'yyyy-MM-dd') + '~' + cx.formatDate(dfop._enddate, 'yyyy-MM-dd');
                $text.html(label);
        ...
        select: function ($self, value) {
            ...
            switch (value) {
                ...
                case 'currentM':
                    ...
                    break;
                case 'preJ':
                    var d = cx.getPreQuarter();
                    dfop._begindate = d.begin;
                    dfop._enddate = d.end;
                    break;
                case 'currentJ':
                    var d = cx.getCurrentQuarter();
                    dfop._begindate = d.begin;
                    dfop._enddate = d.end;
                    break;
                case 'yS':
                    var d = cx.getFirstHalfYear();
                    dfop._begindate = d.begin;
                    dfop._enddate = d.end;
                    break;
                case 'yX':
                    var d = cx.getSecondHalfYear();
                    dfop._begindate = d.begin;
                    dfop._enddate = d.end;
                    break;
                case 'preY':
