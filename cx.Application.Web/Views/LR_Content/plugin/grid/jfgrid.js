                ...
                switch (item.edit.type) {
                    ...
                    case 'datatime':       // 时间
                        if (item.edit.dateformat == "0") {
                            value = cx.formatDate(value, "yyyy-MM-dd");
                            row[item.name] = value;
                        }
    ...
    var _jfgrid = {
        ...
        head: function ($self, op) {
            ...
            $.each(op.running.headData, function (_index, _item) {
                ...
                // 翻译
                cx.language.get((_item.data.label || ""), function (text) {
        ...
        reload: function ($self, op) {
            ...
            if (op.isPage) {
                ...
                cx.httpAsync('GET', op.url, op.param, function (data) {
                    cx.loading(false);
                    if (data) {
