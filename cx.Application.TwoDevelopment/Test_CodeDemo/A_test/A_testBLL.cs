...
namespace cx.Application.TwoDevelopment.Test_CodeDemo
{
    ...
    /// 描 述：test
    /// </summary>
    public class A_testBLL : A_testIBLL
    {
        private A_testService a_testService = new A_testService();
        ...
        public IEnumerable<A_TestEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return a_testService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public A_TestEntity GetA_TestEntity(string keyValue)
        {
            try
            {
                return a_testService.GetA_TestEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                a_testService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, A_TestEntity entity)
        {
            try
            {
                a_testService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
