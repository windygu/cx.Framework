...
namespace cx.Util.Operat
{
    ...
    public class OperatorHelper
    {
        ...
        private string cacheKeyOperator = "cx_adms_operator_";// +登录者token
        private string cacheKeyToken = "cx_adms_token_";// +登录者token
        private string cacheKeyError = "cx_adms_error_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "cx_ADMS_V7_Token";
        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "cx_ADMS_V7_Mark";
        /// <summary>
        /// 获取实例
        /// </summary>
