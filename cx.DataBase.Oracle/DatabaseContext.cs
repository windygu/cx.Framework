...
namespace cx.DataBase.Oracle
{
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("cx.DataBase.Oracle.DLL", "cx.Application.Mapping.DLL").Replace("file:///", "");
            ...
            modelBuilder.HasDefaultSchema("cx");//这里写默认表空间名称
