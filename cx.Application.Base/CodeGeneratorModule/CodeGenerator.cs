...
using cx.Application.BaseModule.CodeGeneratorModule;
using cx.Util;
using System;
    ...
    public class CodeGenerator
    {
        ...
        public string MappingCreate(CodeBaseConfigModel baseConfigModel, string tableName)
        {
            try
            {
                ...
                sb.Append("namespace  cx.Application.Mapping\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
        ...
        public string ServiceCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("using cx.DataBase.Repository;\r\n");
                sb.Append("using cx.Util;\r\n");
                sb.Append("using System;\r\n");
        ...
        public string ControllerCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("namespace cx.Application.Web.Areas." + baseConfigModel.area + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
        ...
        public string ControllerCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("namespace cx.Application.Web.Areas." + baseInfo.outputArea + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseInfo));
        ...
        public string IndexJSCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("                if (cx.checkrow(keyValue)) {\r\n");
                sb.Append("                    cx.layerForm({\r\n");
                sb.Append("                        id: 'form',\r\n");
                sb.Append("                        title: '编辑',\r\n");
                ...
                sb.Append("                var keyValue = $('#gridtable').jfGridValue('" + pk + "');\r\n");
                sb.Append("                if (cx.checkrow(keyValue)) {\r\n");
                sb.Append("                    cx.layerConfirm('是否确认删除该项！', function (res) {\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            cx.deleteForm(top.$.rootUrl + '/" + baseConfigModel.area + "/" + baseConfigModel.name + "/DeleteForm', { keyValue: keyValue}, function () {\r\n");
                sb.Append("                            });\r\n");
                sb.Append("                        }\r\n");
                sb.Append("                    });\r\n");
                sb.Append("                }\r\n");
        ...
        public string IndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                if (queryData.isDate == "1")
                {
                    ...
                    sb.Append("                dfdata: [\r\n");
                    sb.Append("                    { name: '今天', begin: function () { return cx.getDate('yyyy-MM-dd 00:00:00') }, end: function () { return cx.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近7天', begin: function () { return cx.getDate('yyyy-MM-dd 00:00:00', 'd', -6) }, end: function () { return cx.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近1个月', begin: function () { return cx.getDate('yyyy-MM-dd 00:00:00', 'm', -1) }, end: function () { return cx.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近3个月', begin: function () { return cx.getDate('yyyy-MM-dd 00:00:00', 'm', -3) }, end: function () { return cx.getDate('yyyy-MM-dd 23:59:59') } }\r\n");
                    sb.Append("                ],\r\n");
                    sb.Append("                // 月\r\n");
                ...
                foreach (var btn in colData.btns)
                {
                    switch (btn)
                    {
                        ...
                        case "delete":
                            ...
                            sb.Append("                    cx.layerConfirm('是否确认删除该项！', function (res) {\r\n");
                            sb.Append("                        if (res) {\r\n");
                            sb.Append("                            cx.deleteForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/DeleteForm', { keyValue: keyValue}, function () {\r\n");
                ...
                foreach (var col in colData.fields)
                {
                    ...
                    if (compont.type == "select" || compont.type == "radio")
                    {
                        ...
                        if (compont.dataSource == "0")
                        {
                            sb.Append("                             cx.clientdata.getAsync('dataItem', {\r\n");
                            sb.Append("                                 key: value,\r\n");
                            sb.Append("                                 code: '" + compont.itemCode + "',\r\n");
                        ...
                        {
                            string[] vlist = compont.dataSourceId.Split(',');
                            sb.Append("                             cx.clientdata.getAsync('custmerData', {\r\n");
                    ...
                    else if (compont.type == "checkbox")
                    {
                        ...
                        if (compont.dataSource == "0")
                        {
                            sb.Append("                             cx.clientdata.getsAsync('dataItem', {\r\n");
                            sb.Append("                                 key: value,\r\n");
                            sb.Append("                                 code: '" + compont.itemCode + "',\r\n");
                        ...
                        {
                            string[] vlist = compont.dataSourceId.Split(',');
                            sb.Append("                             cx.clientdata.getsAsync('custmerData', {\r\n");
                            sb.Append("                                 url: '/LR_SystemModule/DataSource/GetDataTable?code=' + '" + vlist[0] + "',\r\n");
                            sb.Append("                                 key: value,\r\n");
                            sb.Append("                                 keyId: '" + vlist[2] + "',\r\n");
        ...
        public string WfIndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                foreach (var btn in colData.btns)
                {
                    switch (btn)
                    {
                        case "add":
                            ...
                            sb.Append("                        // 保存数据\r\n");
                            sb.Append("                        if (res) {\r\n");
                            sb.Append("                            processId = cx.newGuid();\r\n");
                ...
                sb.Append("        {\r\n");
                sb.Append("            // 发起流程\r\n");
                sb.Append("            cx.workflowapi.create({\r\n");
                ...
                foreach (var btn in colData.btns)
                {
                    switch (btn)
                    {
                        ...
                        case "save":
                            ...
                            sb.Append("                }\r\n");
                            sb.Append("                else {\r\n");
                            sb.Append("                    cx.alert.warning(\"没有数据需要保存!\");\r\n");
                            sb.Append("                }\r\n");
                ...
                foreach (var col in colData.fields)
                {
                    ...
                    switch (compont.type)
                    {
                        ...
                        case "select":
                            ...
                            if (compont.dataSource == "0")
                            {
                                sb.Append("                            cx.clientdata.getAllAsync('dataItem', {\r\n");
                                sb.Append("                                code:'" + compont.itemCode + "',\r\n");
                            ...
                            {
                                string[] vlist = compont.dataSourceId.Split(',');
                                sb.Append("                            cx.clientdata.getAllAsync('sourceData', {\r\n");
                                sb.Append("                                code:'" + vlist[0] + "',\r\n");
                                sb.Append("                                callback: function (dataes) {\r\n");
                                sb.Append("                                    $edit.lrselectRefresh({\r\n");
                                sb.Append("                                        value: '" + vlist[2] + "',\r\n");
        ...
        public string FormJsCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("var bootstrap = function ($, cx) {\r\n");
                sb.Append("    \"use strict\";\r\n");
                sb.Append("    var selectedRow = cx.frameTab.currentIframe().selectedRow;\r\n");
                sb.Append("    var page = {\r\n");
                sb.Append("        init: function () {\r\n");
                    ...
                    foreach (var compont in tab.componts)
                    {
                        switch (compont.type)
                        {
                            ...
                            case "datetimerange":
                                ...
                                sb.Append("                if (!!st && !!et) {\r\n");
                                sb.Append("                    var diff = cx.parseDate(st).DateDiff('d', et) + 1;\r\n");
                                ...
                                break;
                            case "encode":
                                sb.Append("            cx.httpAsync('GET', top.$.rootUrl + '/LR_SystemModule/CodeRule/GetEnCode', { code: '" + compont.rulecode + "' }, function (data) {\r\n");
                            ...
                            case "currentInfo":
                                switch (compont.dataType)
                                {
                                    case "company":
                                        ...
                                        sb.Append("                key: cx.clientdata.get(['userinfo']).companyId,\r\n");
                                        sb.Append("                callback: function (_data) {\r\n");
                                        ...
                                        break;
                                    case "department":
                                        sb.Append("            $('#" + compont.field + "')[0].lrvalue = cx.clientdata.get(['userinfo']).departmentId;\r\n");
                                        sb.Append("            cx.clientdata.getAsync('department', {\r\n");
                                        sb.Append("                key: cx.clientdata.get(['userinfo']).departmentId,\r\n");
                                        sb.Append("                callback: function (_data) {\r\n");
                                        sb.Append("                    $('#" + compont.field + "').val(_data.name);\r\n");
                                        sb.Append("                }\r\n");
                                        sb.Append("            });\r\n");
                                        break;
                                    case "user":
                                        sb.Append("            $('#" + compont.field + "')[0].lrvalue = cx.clientdata.get(['userinfo']).userId;\r\n");
                                        sb.Append("            $('#" + compont.field + "').val(cx.clientdata.get(['userinfo']).realName);\r\n");
                                        break;
                                    case "time":
                                        sb.Append("            $('#" + compont.field + "').val(cx.formatDate(new Date(), 'yyyy-MM-dd hh:mm:ss'));\r\n");
                                        break;
                                }
                                break;
                            case "upload":
        ...
        public void CreateMapCodeFile(CodeBaseConfigModel codeBaseConfigModel, string tableName, string codeContent)
        {
            try
            {
                ...
                CreateCodeFile(codeBaseConfigModel.mappingDirectory + "\\" + backArea + tableName + "Map.cs", codeContent, codeBaseConfigModel.mappingDirectory + "\\cx.Application.Mapping.csproj", backArea + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateMapCodeFile(BaseModel baseInfo, string tableName, string codeContent)
        {
            ...
            {
                string backProject = ConfigurationManager.AppSettings["BackProject"].ToString();
                CreateCodeFile(baseInfo.mappingDirectory + "\\" + baseInfo.outputArea + "\\" + tableName + "Map.cs", codeContent, baseInfo.mappingDirectory + "\\cx.Application.Mapping.csproj", baseInfo.outputArea + "\\" + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", codeContent, codeBaseConfigModel.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", codeContent, baseInfo.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", codeContent, baseInfo.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", codeContent, codeBaseConfigModel.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", codeContent, baseInfo.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", codeContent, baseInfo.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", codeContent, codeBaseConfigModel.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", codeContent, baseInfo.webDirectory + "\\cx.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateApiFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.apiDirectory + "\\Modules\\" + baseInfo.outputArea + "\\" + baseInfo.name + "Api.cs", codeContent, baseInfo.apiDirectory + "\\cx.Application.WebApi.csproj", "Modules\\" + baseInfo.outputArea + "\\" + baseInfo.name + "Api.cs", false);
            }
            catch (Exception)
            {
                throw;
