...
namespace cx.DataBase.SqlServer
{
    /// <summary>
    /// 版 本 1.0 辰星开发框架
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("cx.DataBase.SqlServer.DLL", "cx.Application.Mapping.DLL").Replace("file:///", "");
